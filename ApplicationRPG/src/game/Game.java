...
public class Game {
	...
	public static void main(String[] args) {
		UserInterface ui = ConsoleUserInterface.getInstance(); //TODO : à utiliser pour geline(), ou remplacer system.out par xx.getInstance()
...
//		mosquitoSwarm3.attack(player);
	...
	public static void goToPlace(Player player, Place place) {
		if(player.getCurrentPlace().isConnectedTo(place)) {
			...
			ConsoleUserInterface.getInstance().print("impossible");
		}
	}
}
